...
from malariagen_data.anoph.dipclust import AnophelesDipClust


@pytest.fixture
def ag3_sim_api(ag3_sim_fixture):
    return AnophelesDipClust(
...
def test_plot_diplotype_clustering(fixture, api: AnophelesDipClust, distance_metric):
