...
from . import admixture_stats_params, base_params


@numba.njit
def remap_observed(ac_full):
...
def patterson_f3(
    ...
    sqz_mapping = remap_observed(ac_bi)
    ...
    if segregating_mode == "recipient":
        ...
        acc_seg = acc_sqz.is_segregating()
        aca_seg = aca_sqz.is_segregating()
        acb_seg = acb_sqz.is_segregating()
    else:
