...
class Adar1(AnophelesDataResource):
    ...
    **kwargs
    ...
    Access data from Google Cloud Storage (default):
        ...
        >>> import malariagen_data
        >>> adir1 = malariagen_data.Adar1()

    Access data downloaded to a local file system:

        >>> adir1 = malariagen_data.Adar1("/local/path/to/vo_adar_release/")
    ...
    def __init__(
        ...
        **storage_options,  # used by fsspec via init_filesystem()
        ...
        super().__init__(
            ...
            gff_gene_type="protein_coding_gene",  # Need to check that it is true
            gff_gene_name_attribute="Note",  # Need to check that it is true
            gff_default_attributes=(
                "ID",
                "Parent",
                "Note",
                "description",
            ),  # Need to check that it is true
