...
- Adds the `Af1` class providing access to the _Anopheles funestus_
...
- `Ag3`: All dataframe columns containing allele frequency values are
  now prefixed with "frq\_" to allow for easier selection of frequency
  columns
...
- Adds the `Amin1` class providing access to the _Anopheles minimus_
